...
cmake -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DCLASSB_ENABLED=ON  -DAPPLICATION="LoRaMac" -DSUB_PROJECT="classA" -DCMAKE_TOOLCHAIN_FILE="cmake/toolchain-arm-none-eabi.cmake" -DBOARD="L496xx" -DMBED_RADIO_SHIELD=SX1276MB1LAS -DACTIVE_REGION="LORAMAC_REGION_EU868" ..
